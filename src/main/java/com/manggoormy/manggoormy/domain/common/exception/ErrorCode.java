...
import com.manggoormy.manggoormy.domain.common.http.HttpStatusCode;
import lombok.Getter;

import static com.manggoormy.manggoormy.domain.common.http.HttpStatusCode.*;
...
public enum ErrorCode {
    ...
    E400_INVALID_LATITUDE_RANGE(BAD_REQUEST, false, "BR006", "잘못된 위도를 입력하였습니다\n(33.1 ~ 38.61 사이의 위도를 입력해주세요)"),
    E400_INVALID_LONGITUDE_RANGE(BAD_REQUEST, false, "BR007", "잘못된 경도를 입력하였습니다\n(124.60 ~ 131.87 사이의 경도를 입력해주세요)"),
    ...
    E404_NOT_EXISTS_MEDAL(NOT_FOUND, false, "N006", "존재하지 않은 메달입니다"),
    E404_NOT_EXISTS_USER_MEDAL(NOT_FOUND, false, "N007", "보유하지 않은 메달입니다"),
    E404_NOT_EXISTS_CATEGORY(NOT_FOUND, false, "N008", "존재하지 않는 카테고리 입니다"),
    E404_NOT_EXISTS_BOSS_ACCOUNT(NOT_FOUND, false, "N009", "존재하지 않는 사장님 계정입니다"),
